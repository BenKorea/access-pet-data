# 프로젝트 목적
Access로 구축되었던 PET 판독 및 준비기록과 OCS PET 판독 및 준비기록, PACS PET 검사기록을 비교분석하여 PET 준비기록 중 보관이 필요한 기간을 분석하고자 합니다.

# 프로젝트 개요
- 아래의 Wiki 문서 링크를 참고하십시오.
...
- 참조: [R-Logging-Reference](wiki/R-Logging-Reference.md)
